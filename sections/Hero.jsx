      ...
      >
        ...
        flex-col relative z-10">
          ...
          <motion.div
            ...
            className="flex flex-rox justify-center"
            >

            <h1 className={styles.heroHeading}>Lu</h1>
            <div className={styles.heroDText} />
            <h1 className={styles.heroHeading}>De</h1>
          </motion.div>
        </div>
